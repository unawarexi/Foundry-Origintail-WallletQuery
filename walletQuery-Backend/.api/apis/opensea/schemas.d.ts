    ...
    readonly metadata: {
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly chain: {
                    readonly type: "string";
                    readonly enum: readonly ["abstract", "ape_chain", "arbitrum", "arbitrum_nova", "avalanche", "b3", "base", "bera_chain", "blast", "ethereum", "flow", "klaytn", "matic", "optimism", "ronin", "shape", "solana", "soneium", "unichain", "zora"];
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
